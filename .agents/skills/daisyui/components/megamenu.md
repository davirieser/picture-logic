...
<div
	class="{MODIFIER} megamenu border border-base-300 p-2 max-sm:megamenu-vertical"
	id="my-megamenu-1"
	popover
>
...
<div
	class="megamenu megamenu-wide w-full border border-base-300 p-2 max-sm:megamenu-vertical"
	id="my-megamenu-2"
	popover
>
	<span class="megamenu-active"></span>
